...
class Message(models.Model):
    ...
    file = CloudinaryField('file', blank=True, null=True)  # Updated to use CloudinaryField
    file_name = models.CharField(max_length=255, blank=True, null=True)
    file_type = models.CharField(max_length=100, blank=True, null=True)
    file_size = models.BigIntegerField(blank=True, null=True)
    public_id = models.CharField(max_length=255, blank=True, null=True)  # New field for Cloudinary public_id
    ...
    def __str__(self):
        ...
        if self.content and self.file:
            ...
            return f"{base_str}: File: {self.file_name} (type: {self.file_type}, size: {self.file_size}, public_id: {self.public_id})"
        elif self.content:
